<x-layout>
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-83.75 w-full flex-col lg:max-w-5xl lg:flex-row">
            <div class="text-[13px] leading-5 flex-1 p-6 pb-12 lg:p-20 bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-bl-lg rounded-br-lg rounded-tl-lg rounded-tr-lg mb-2 lg:mb-0 lg:rounded-tl-lg lg:rounded-br-lg lg:rounded-tr-lg">
                <h1 class="mb-1 font-large text-2xl">{{ __('general.welcometo') }}</h1>
                <p class="mb-4 text-[#706f6c]">{{ __('general.welcomemessage') }}</a></p>
            </div>
